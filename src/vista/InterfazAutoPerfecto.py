...
class App_AutoPerfecto(QApplication):
    ...
    def mostrar_acciones(self, id_auto):
        ...
        placa_auto = self.logica.dar_auto(id_auto)['placa']
        self.vista_lista_acciones=Vista_lista_acciones(self)
        self.vista_lista_acciones.mostrar_acciones(placa_auto, self.logica.dar_acciones_auto(id_auto))
    ...
    def aniadir_accion(self, mantenimiento, valor, kilometraje, fecha):
        ...
        if self.logica.validar_crear_editar_accion(None, mantenimiento, self.auto_actual, valor, kilometraje, fecha):
            ...
            placa_auto = self.logica.dar_auto(self.auto_actual)['placa']
            self.vista_lista_acciones.mostrar_acciones(placa_auto, self.logica.dar_acciones_auto(self.auto_actual))
        else:
    ...
    def mostrar_reporte_gastos(self):
        ...
        """
        lista_gastos, valor_kilometro, total_gastos = self.logica.dar_reporte_ganancias(self.auto_actual)
        self.vista_reporte_gastos = Vista_reporte_gastos(self)
        self.vista_reporte_gastos.mostrar_gastos(lista_gastos, valor_kilometro, total_gastos)
