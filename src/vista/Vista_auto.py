...
class Vista_auto(QWidget):
    ...
    def mostrar_auto(self, auto):
        ...
        if self.auto != None:
            ...
            self.texto_kilometraje.setText(str(self.auto["kilometrajeCompra"]))
    ...
    def guardar_cambios(self):
        ...
        """
        if self.interfaz.guardar_auto(self.texto_marca.text(), self.texto_placa.text(), self.texto_modelo.text(),
                                      self.texto_kilometraje.text(), self.texto_color.text(),
                                      self.texto_cilindraje.text(),
                                      self.texto_tipo_combustible.text()) != False:
            self.hide()
            self.interfaz.mostrar_vista_lista_autos()
        else:
            self.error_auto()
    ...
    def error_auto(self):
        ...
        mensaje_error.setText(
            "Verifique que todos los campos se encuentren diligenciados y que el kilometraje sea un valor numérico.")
